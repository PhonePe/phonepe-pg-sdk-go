...
// PaymentFlowInterface is an interface for polymorphic payment flows
type PaymentFlowInterface interface {
	GetType() models.PaymentFlowType
}

type PaymentFlow struct {
	Type models.PaymentFlowType `json:"type"`
}

func (p *PaymentFlow) GetType() models.PaymentFlowType {
	return p.Type
}
...
func NewPgPaymentFlow(paymentMode p_instruments.PaymentV2Instrument, merchantUrls *MerchantUrls) *PgPaymentFlow {
	return &PgPaymentFlow{
		PaymentFlow:  PaymentFlow{Type: models.PG},
